 ...
 * Operate an item.
 *
 * @author Lava, created on 22-10-2013.
 */
public class OperateItem {
	...
	public static void applyOperate(Player player, int itemId, int slot) {
		...
		switch (itemId) {
		case 16505:
			player.getPA().sendMessage("I help you with 7% droprate");
			break;
			// Completionist cape.
		case 14011:
		...
		case 13331:
		case 13329:
			Teleport.spellTeleport(player, 2270 + Misc.random(10), 5345 + Misc.random(2), 0, false);
			break;
		case 1215:
		case 1231:
		case 5680:
	...
	public static void operateOption(Player player, int option, int itemId) {
		...
		case 21166:
			...
			Teleport.startTeleport(player, posX, posY, H, "BURNING_AMULET " + itemId + " " + "EQUIPMENT");
			break;
		}
