...
public class Area {
	...
	public static boolean inZulrah(Player player) {
		if (isWithInArea(player, 2250, 3060, 2290, 3090)) {
			return true;
		}
		return false;
	}
	...
	public static boolean isWithinVarrock(Position position) {
		return PositionUtils.isWithinBoundary(position, 3176, 3260, 3403, 3491);
	}

	public static boolean isWithinEdgeville(Position position) {
		return PositionUtils.isWithinBoundary(position, 3071, 3144, 3463, 3519);
	}

	/**
	 * Checks if the {@code source} is located inside a bank of Niobe.
	 * 
	 * @param source The {@link org.niobe.model.GameCharacter} to check boundary
	 *               for.
	 * @return If {@code true} the player is in a bank.
	 */
	public static boolean inBank(Player source) {
		if (source.getPosition().getX() > 3090 && source.getPosition().getX() < 3099
				&& source.getPosition().getY() > 3487 && source.getPosition().getY() < 3500
				|| source.getPosition().getX() > 3089 && source.getPosition().getX() < 3090
						&& source.getPosition().getY() > 3492 && source.getPosition().getY() < 3498
				|| source.getPosition().getX() > 3248 && source.getPosition().getX() < 3258
						&& source.getPosition().getY() > 3413 && source.getPosition().getY() < 3428
				|| source.getPosition().getX() > 3179 && source.getPosition().getX() < 3191
						&& source.getPosition().getY() > 3432 && source.getPosition().getY() < 3448
				|| source.getPosition().getX() > 2944 && source.getPosition().getX() < 2948
						&& source.getPosition().getY() > 3365 && source.getPosition().getY() < 3374
				|| source.getPosition().getX() > 2942 && source.getPosition().getX() < 2948
						&& source.getPosition().getY() > 3367 && source.getPosition().getY() < 3374
				|| source.getPosition().getX() > 2944 && source.getPosition().getX() < 2950
						&& source.getPosition().getY() > 3365 && source.getPosition().getY() < 3370
				|| source.getPosition().getX() > 3008 && source.getPosition().getX() < 3019
						&& source.getPosition().getY() > 3352 && source.getPosition().getY() < 3359
				|| source.getPosition().getX() > 3017 && source.getPosition().getX() < 3022
						&& source.getPosition().getY() > 3352 && source.getPosition().getY() < 3357
				|| source.getPosition().getX() > 3203 && source.getPosition().getX() < 3213
						&& source.getPosition().getY() > 3200 && source.getPosition().getY() < 3237
				|| source.getPosition().getX() > 3212 && source.getPosition().getX() < 3215
						&& source.getPosition().getY() > 3200 && source.getPosition().getY() < 3235
				|| source.getPosition().getX() > 3215 && source.getPosition().getX() < 3220
						&& source.getPosition().getY() > 3202 && source.getPosition().getY() < 3235
				|| source.getPosition().getX() > 3220 && source.getPosition().getX() < 3227
						&& source.getPosition().getY() > 3202 && source.getPosition().getY() < 3229
				|| source.getPosition().getX() > 3227 && source.getPosition().getX() < 3230
						&& source.getPosition().getY() > 3208 && source.getPosition().getY() < 3226
				|| source.getPosition().getX() > 3226 && source.getPosition().getX() < 3228
						&& source.getPosition().getY() > 3230 && source.getPosition().getY() < 3211
				|| source.getPosition().getX() > 3227 && source.getPosition().getX() < 3229
						&& source.getPosition().getY() > 3208 && source.getPosition().getY() < 3226) {
			return true;
		}
		return false;
	...
	private static boolean isWithInArea(int currentX, int currentY, int currentHeight, int X1, int X2, int Y1, int Y2,
			int requiredHeight) {
	...
	public static boolean isInBarrowsChestArea(Player player) {
		return player.getX() >= 3520 && player.getX() <= 3590 && player.getY() >= 9680 && player.getY() <= 9730
				&& player.getHeight() == 3;
	}
	...
	public static boolean inCityPvpArea(Player player) {
		if (player.getHeight() ==8) {
			return true;
		}
		if (player.getHeight() != 4) {
			return false;
		}
		if (!inEdgevilleBankPvpInstance(player.getX(), player.getY(), player.getHeight()) && player.getX() >= 0
				&& player.getY() >= 0) {
			return true;
		}
		return false;
	 ...
	 * @return True, if the player is in the safe PK zone where players can attack
	 *         each other.
	 */
	...
	public static boolean inMulti(int x, int y) {
		// Do not add Zombie areas to this, make a different one where if the npc is
		// spawned in a zombie instance, then it is multi, and player is in zombie
		// instance, then multi.
	...
	public static boolean inRevs(Player player) {
		if (isWithInArea(player, 2900, 2999, 10120, 10250)) {
	...
	public static boolean inVorkath(Player player) {
		if (isWithInArea(player, 2262, 2282, 4040, 4076 )) {
	...
	public static boolean inUber(Player player) {
		if (isWithInArea(player, 2400, 3125, 2100, 2874)) {
			return true;
		}
		return false;
