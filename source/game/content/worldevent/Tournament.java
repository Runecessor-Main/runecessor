 ...
 * Tournament.
 *
 * @author Lava, created on 06-03-2017.
 */
public class Tournament {
	...
	private static void tournamentStart() {
		...
		boolean has8 = playerListLobby.size() >= 6;
		...
		if (has8) {
			...
			Announcement.announce("6 players needed to start, cancelled.", ServerConstants.DARK_BLUE);
			cancelTournament();
			return;
		}
		tournamentTickCount = 0;
...
//		}
	...
	public static void tournamentKick(Player player, String name) {
		try {
			...
			player.getPA().sendMessage("Use as ::tournamentkick Lava");
		}
