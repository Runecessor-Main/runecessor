...
public class Potions {
    ...
    public static void handlePotion(Player player, int itemId, int slot) {
        ...
        long delay = 1700;
        if (player.getHeight() == 8 && System.currentTimeMillis() - player.getBankDelay() < 3000)
            return;
        ...
        if (player.showPotionMessage) {
            ...
            if (ItemAssistant.getItemName(itemId).contains("Guthix rest")) {
                ...
                if (item.endsWith("(6)")) {
                    ...
                    if (player.getPlayerDetails() != null && player.getPlayerDetails().getUnlocksList().contains(SlayerUnlocks.AUTO_SMASH_VIALS.ordinal())) {
