 ...
 * Announcements.
 *
 * @author Lava, created on 08-01-2015.
 */
public class Announcement {
				...
				String[] message =
						{
								...
								"Wilderness bosses is the fastest way to make money.",
								"Never use a password from another website/rsps or you might get hacked!",
								"You can purchase skill capes from the Wise Old Man.",
								"Kill revenants for Money! One of the top money making methods.",
								"View the guidebook in your quest tab to learn alot.",
								"Kill Chaos elemental for Money! One of the top money making methods.",
								...
								"Become rich by thieving stalls at home",
								...
								"Hybridding gives you 2x artefacts from Pking!",
								...
								"Use blood keys on the chest at home for rewards.",
	...
	public static void donateAnnouncementAction() {
		String[] donateText =
				{
						"Try your luck and buy a M-box for only $2.50, you may win a Party hat! ::donate",
						"Donate to help your favorite server grow ::donate",
