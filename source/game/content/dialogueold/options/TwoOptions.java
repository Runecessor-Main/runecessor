...
public class TwoOptions {
	...
	public static void firstOption(Player player) {
		...
		switch (player.getDialogueAction()) {
			...
			case 611:
				player.getPA().openWebsite("https://runecessor.com/forum/index.php?/topic/113-mystery-boxes/", true);
	...
	public static void secondOption(Player player) {
		switch (player.getDialogueAction()) {
			...
			// Tutorial,  No thanks, i know my way around Runecessor
			case 272:
			...
			// Tutorial,  No thanks, i know my way around Runecessor (eco)
			case 562:
			...
			case 611:
				player.getPA().openWebsite("https://runecessor.com/forum/index.php?/topic/114-pet-mystery-boxes/", true);
				player.getDH().sendDialogues(257);
				break;
