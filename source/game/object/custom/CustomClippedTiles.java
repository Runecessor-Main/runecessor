...
public class CustomClippedTiles {
	...
	public static void removeClippedTileOsrs() {
		...
		//Region.addObject(409, 3093, 3513, 0, 10, 0, false);
		//Region.addObjectActionTile(409, 3093, 3513, 2, 0, 0);
	...
	//	Region.addObjectActionTile(23709, 3091, 3493, 0, 1, 1);
		...
		Region.addObjectActionTile(409,  3093, 3513, 2, 10, 0);
		Region.addObjectActionTile(29150, 3099, 3507, 1, 10, 0);

		// catherby bank fix
		Region.addObjectActionTile(6943, 2810, 3442, 0, 1, 1);
		// Staff Zone Bank Fix
		Region.addObjectActionTile(10083, 3107, 3098, 0, 1, 1);
		Region.addObjectActionTile(10083, 3108, 3098, 0, 1, 1);
		Region.addObjectActionTile(10083, 3109, 3098, 0, 1, 1);
		Region.addObjectActionTile(10083, 3110, 3098, 0, 1, 1);
		...
		if (GameType.isOsrsEco()) {
			...
			Region.addObjectActionTile(6163, 3084, 3486, 0, 1, 1);
			Region.addObjectActionTile(6165, 3084, 3488, 0, 1, 1);
			Region.addObjectActionTile(6166, 3084, 3490, 0, 1, 1);
			Region.addObjectActionTile(6164, 3084, 3492, 0, 1, 1);
			Region.addObjectActionTile(6162, 3084, 3494, 0, 1, 1); //stalls
		...
		//	Region.addObjectActionTile(13213, 3094, 3513, 0, 1, 1); //burners
			...
			Region.addObjectActionTile(30251, 3238, 3435, 0, 3, 3); //Well of godwill
...
//thats because the vps doesnt have sound system its nothing ok
			//Fossil island
			Region.addObjectActionTile(3194, 3742, 3805, 0, 1, 1); //Bank chest

			//Region.addObjectActionTile(29211, 3205, 3417, 0, 2, 2); //Skillcape stand
...
//ladder 2796, 3112, 9690, 0, 10, 0, 0, false);
		Region.addObjectActionTile(2796, 3112, 9690, 0, 1, 1);
	...
	//	Region.addObjectActionTile(563, 3093, 3507, 0, 1, 1);
		...
		// Varrock Home
		Region.addObject(29211, 3205, 3417, 0, 0, 3, true);
	...
	private static void removeGatesAndDoorClipping() {
		...
		Region.removeClipping(3109, 3353, 0);
		Region.removeClipping(3108, 3353, 0);
		Region.removeClipping(3112, 3356, 0);
		Region.removeClipping(3112, 3355, 0);
		Region.removeClipping(3108, 3354, 0);
		Region.removeClipping(3108, 3353, 0);
		Region.removeClipping(3252, 3267, 0);
		Region.removeClipping(3252, 3356, 0);
		Region.removeClipping(3253, 3266, 0);
		Region.removeClipping(3253, 3267, 0);
		Region.removeClipping(3112, 3356, 0);
		Region.removeClipping(3112, 3355, 0);
		Region.removeClipping(3113, 3355, 0);
		Region.removeClipping(3113, 3356, 0);
		Region.removeClipping(3237, 3296, 0);
		Region.removeClipping(3237, 3295, 0);
		Region.removeClipping(3237, 3295, 0);
		Region.removeClipping(3237, 3296, 0);
		Region.removeClipping(3237, 3296, 0);
		Region.removeClipping(3237, 3295, 0);
		Region.removeClipping(3236, 3296, 0);
		Region.removeClipping(3236, 3295, 0);
